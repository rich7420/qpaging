...
impl AsyncIoEngine {
    ...
    pub fn submit_prefetch(&mut self, pages: &BitVec, base_addr: *const u8) -> std::io::Result<usize> {
    ...
    fn submit_madvise_op(&mut self, base_addr: *const u8, start_page_idx: usize, num_pages: usize) -> std::io::Result<()> {
